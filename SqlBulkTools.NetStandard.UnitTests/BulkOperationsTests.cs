...
namespace SqlBulkTools.UnitTests
{
    public class BulkOperationsTests
    {
        ...
        public void BulkOperationsHelpers_BuildJoinConditionsForUpdateOrInsertWithTwoConditions()
        {
            ...
            // Act
            var result = BulkOperationsHelper.BuildJoinConditionsForInsertOrUpdate(joinOnList.ToArray(), "Source", "Target",
                new Dictionary<string, string> {{"FK_BusinessId", "DEFAULT_COLLATION"}}, new Dictionary<string, bool>());

            // Assert
            Assert.Equal(
                "ON ([Target].[MarketPlaceId] = [Source].[MarketPlaceId]) AND ([Target].[FK_BusinessId] = [Source].[FK_BusinessId] COLLATE DEFAULT_COLLATION) ",
                result);
        }
        ...
        public void BulkOperationsHelpers_BuildInsertIntoSet_BuildsCorrectSequenceForMultipleColumns()
        {
            ...
            const string tableName = "TableName";
            const string expected = "INSERT INTO TableName ([Email], [IsCool], [Name], [Town]) ";
        ...
        public void BulkOperationsHelpers_BuildInsertSet_BuildsCorrectSequenceForSingleColumn()
        {
            // Arrange
            var updateOrInsertColumns = new HashSet<string> {"Id"};
            const string expected = "INSERT ([Id]) values ([Source].[Id])";
        ...
        public void BulkOperationsHelper_GetAllPropertiesForComplexType_ReturnsCorrectSet()
        {
            ...
            {
                "AverageEstimate_TotalCost", "AverageEstimate_CreationDate", "Competition", "Id", "MinEstimate_TotalCost", "MinEstimate_CreationDate",
                "SearchVolume"
            };
        ...
        public void BulkOperationsHelper_CreateDataTableForComplexType_IsStructuredCorrectly()
        {
            ...
            {
                "AverageEstimate_TotalCost", "AverageEstimate_CreationDate", "Competition", "MinEstimate_TotalCost", "MinEstimate_CreationDate",
                "SearchVolume"
            };
            var propertyInfoList = typeof(ComplexTypeModel).GetProperties().OrderBy(x => x.Name).ToList();
        ...
        {
            // Arrange
            const string expected = "[db].[CustomSchemaName].[TableName]";
        ...
        {
            // Arrange
            const string expected = "DROP TABLE #TmpOutput;";
        ...
        public void BulkOperationsHelper_BuildPredicateQuery_LessThanDecimalCondition()
        {
            ...
            const string expected = "AND [Target].[Price] < @PriceCondition1 ";
        ...
        public void BulkOperationsHelper_BuildPredicateQuery_IsNullCondition()
        {
            ...
            const string expected = "AND [Target].[Description] IS NULL ";
        ...
        public void BulkOperationsHelper_BuildPredicateQuery_IsNotNullCondition()
        {
            ...
            const string expected = "AND [Target].[Description] IS NOT NULL ";
        ...
        public void BulkOperationsHelper_BuildPredicateQuery_LessThan()
        {
            ...
            const string expected = "AND [Target].[Description] < @DescriptionCondition1 COLLATE DEFAULT_COLLATION ";

            // Act
            var result = BulkOperationsHelper.BuildPredicateQuery(updateOn, conditions, targetAlias,
                new Dictionary<string, string> {{"Description", "DEFAULT_COLLATION"}});
        ...
        public void BulkOperationsHelper_BuildPredicateQuery_LessThanOrEqualTo()
        {
            ...
            const string expected = "AND [Target].[Description] <= @DescriptionCondition1 ";
        ...
        public void BulkOperationsHelper_BuildPredicateQuery_CustomColumnMapping()
        {
            ...
            const string expected = "AND [Target].[ShortDescription] >= @DescriptionCondition1 ";
        ...
        public void BulkOperationsHelper_BuildPredicateQuery_MultipleConditions()
        {
            ...
            const string expected = "AND [Target].[Description] IS NOT NULL AND [Target].[Price] >= @PriceCondition2 ";
        ...
        public void BulkOperationsHelper_BuildPredicateQuery_ThrowsWhenUpdateOnColIsEmpty()
        {
            ...
            const string expectedMessage = "MatchTargetOn is required for AndQuery.";
        ...
        {
            // Arrange
            var columns = new HashSet<string> {"TestColumnA", "TestColumnB"};
        ...
        {
            // Arrange
            var columns = new HashSet<string> {"TestColumnA", "TestColumnB", "Id"};
        ...
        public void BulkOperationsHelper_AddSqlParamsForUpdateQuery_GetsTypeAndValue()
        {
            ...
            var columns = new HashSet<string> {"ISBN", "Price", "BestSeller"};
